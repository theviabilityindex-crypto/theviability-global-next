...
function calculateCanadaResult(params: {
  ...
  let score = chainIntegrity + documentationReadiness + generationComplexity + trackStrength;
  ...
  if (status === "Eligible now") {
    ...
    nextStepHeadline = "You need an investigation plan before you need an application plan.";
    nextStepBody =
...
export default function CanadaEligibilityCalculator() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!birthTrack || !generationDepth || !anchorType || !renunciationRisk || !documentsState) {
      setError("Complete all diagnostic questions before running the check.");
      return;
    }

    if (birthTrack === "after_cutoff" && !parentDaysMet) {
      setError("Tell us whether the 1,095-day requirement appears met for the post-cutoff track.");
      return;
    }
                ...
                {birthTrack === "after_cutoff" ? (
                  <div>
                    <label
                      ...
                      className="block text-sm font-medium text-neutral-900"
                    >
                      If your Canadian parent was also born abroad, do they appear to have 1,095 days in Canada before your birth?
                    </label>
                    <select
                      id="parent-days"
                      value={parentDaysMet}
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-2xl border border-neutral-200 p-4">
                    ...
                    <div className="mt-2 text-sm text-neutral-600">
                      {birthTrack === "before_cutoff"
                        ? "Pre-December 15, 2025 logic."
                        : "Post-December 15, 2025 logic with substantial-connection risk."}
                    </div>
                  </div>
                  ...
                  {showQuestions ? (
                    ...
                    >
                      ...
                      <p className="mt-2 text-sm leading-6 text-neutral-600">
                        Answer 4 quick questions to generate your personalised next-step plan.
                      </p>
                      ...
                      <div className="mt-6 space-y-6">
                          ...
                          <div className="mt-3 space-y-2">
                            <label className="flex cursor-pointer items-center gap-3 rounded-none border border-neutral-300 bg-white px-4 py-3 text-sm">
                              <input
                                ...
                                onChange={() => updateFixPlanAnswers("ancestorKnown", "yes")}
                              />
                              <span>Yes</span>
                            </label>
                            <label className="flex cursor-pointer items-center gap-3 rounded-none border border-neutral-300 bg-white px-4 py-3 text-sm">
                              <input
                                ...
                                onChange={() => updateFixPlanAnswers("ancestorKnown", "no")}
                              />
                          ...
                          <div className="mt-3 space-y-2">
                            ...
                            <label className="flex cursor-pointer items-center gap-3 rounded-none border border-neutral-300 bg-white px-4 py-3 text-sm">
                              <input
                                type="radio"
                                name="renunciation-check"
                                checked={fixPlanAnswers.renunciationCheck === "not_sure"}
                                onChange={() =>
                                  updateFixPlanAnswers("renunciationCheck", "not_sure")
                                }
                              />
                          ...
                          <div className="mt-3 space-y-2">
                            <label className="flex cursor-pointer items-center gap-3 rounded-none border border-neutral-300 bg-white px-4 py-3 text-sm">
                              <input
                                ...
                                checked={fixPlanAnswers.documentsState === "full_chain"}
                                onChange={() =>
                                  updateFixPlanAnswers("documentsState", "full_chain")
                                }
                              />
                        ...
                        <div>
                          <label className="block text-sm font-medium text-neutral-900">
                            Do you know the province or territory your Canadian ancestor came from?
                          </label>
                          <div className="mt-3 space-y-2">
                            <label className="flex cursor-pointer items-center gap-3 rounded-none border border-neutral-300 bg-white px-4 py-3 text-sm">
                              <input
                                ...
                                onChange={() => updateFixPlanAnswers("provinceKnown", "yes")}
                              />
                              <span>Yes</span>
                            </label>
                            <label className="flex cursor-pointer items-center gap-3 rounded-none border border-neutral-300 bg-white px-4 py-3 text-sm">
                              <input
                                ...
                                onChange={() => updateFixPlanAnswers("provinceKnown", "no")}
                              />
                  ...
                  <div className="rounded-2xl border border-neutral-200 bg-white p-4">
                    ...
                    <p className="mt-3 text-sm leading-6 text-neutral-700">
                      ...
                      documentation readiness, generation complexity, and the
                      legal strength of your current track.
                    </p>
                  ...
                  <div className="rounded-2xl border border-neutral-200 bg-white p-4">
                    ...
                    <p className="mt-2 text-sm leading-6 text-neutral-700">
                      Enter your email if you want to save your current result to this browser session.
                    </p>
                  ...
                  {modalState === "fix-plan" ? (
                    <div className="rounded-3xl border border-neutral-950 bg-white p-5 shadow-sm sm:p-6">
                      ...
                      <h3 className="mt-2 text-2xl font-semibold tracking-tight text-neutral-950">
                        {displayScore.status === "Eligible now"
                          ? "Protect your claim before avoidable delay weakens it."
                          : "Do not treat this as filing-ready yet."}
                      </h3>
                      <p className="mt-3 text-sm leading-7 text-neutral-700">
                        {displayScore.status === "Eligible now"
                          ? "Your position looks strong enough to justify the premium claim-protection path. The goal now is to tighten your evidence and sequence the next steps properly."
                          : "Your next move is not a random application. It is a structured readiness plan that tells you what to gather, what to verify, and what could delay or weaken the claim."}
                      </p>
                      ...
                      <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-xl border border-neutral-300 bg-white px-6 py-3 text-sm font-medium text-neutral-950 transition hover:bg-neutral-100"
                        >
                          Not now
                        </button>
                      </div>
